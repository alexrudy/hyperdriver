...
pub use chateau::client::PoolConfig as ConnectionManagerConfig;
...
pub use chateau::client::conn::service;
pub use chateau::client::{ConnectionManagerLayer, ConnectionManagerService};
