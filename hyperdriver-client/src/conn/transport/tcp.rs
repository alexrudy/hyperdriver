...
//!
//! Normally, you will not need to use this module directly. Instead, you can use the [`Client`][crate::Client]
//! type, which uses the [`TcpTransport`] internally by default.
//!
//! See [`Client::build_tcp_http`][crate::Client::build_tcp_http] for the default constructor which uses the TCP transport.
...
use crate::builder::BuildTransport;
use crate::conn::dns::{GaiResolver, IpVersion, SocketAddrs};
...
/// # Example
/// ```no_run
/// # use hyperdriver_client::conn::transport::tcp::TcpTransport;
/// # use hyperdriver_client::conn::dns::GaiResolver;
/// # use hyperdriver_core::stream::tcp::TcpStream;
/// # use tower::ServiceExt as _;
///
/// # async fn run() {
