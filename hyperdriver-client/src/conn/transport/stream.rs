...
mod fut {
    ...
    use crate::conn::Stream;
    use crate::conn::{Transport, TransportStream};
    use hyperdriver_core::info::{BraidAddr, HasConnectionInfo};
...
mod tests {
    ...
    use crate::conn::transport::duplex::DuplexTransport;
    use crate::conn::transport::TransportExt as _;
