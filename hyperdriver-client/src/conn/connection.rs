...
pub use crate::pool::key::UriError;
...
impl HttpConnection {
    ...
    pub(super) fn h1(
        conn: hyper::client::conn::http1::SendRequest<hyperdriver_body::Body>,
    ) -> Self {
        HttpConnection {
    ...
    pub(super) fn h2(
        conn: hyper::client::conn::http2::SendRequest<hyperdriver_body::Body>,
    ) -> Self {
        HttpConnection {
...
enum InnerConnection {
    H2(hyper::client::conn::http2::SendRequest<hyperdriver_body::Body>),
    H1(hyper::client::conn::http1::SendRequest<hyperdriver_body::Body>),
}
...
impl Connection for HttpConnection {
    ...
    fn send_request(&mut self, mut request: hyperdriver_body::Request) -> Self::Future {
