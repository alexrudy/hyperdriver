...
//! # Example
//! ```rust
//! # use hyperdriver_body::{Request, Response};
//! # use hyperdriver_core::stream::duplex;
//! # use hyperdriver_server::Server;
...
use hyperdriver_core::service::MakeServiceRef;
...
mod tests {
    ...
    use hyperdriver_body::Body;
    use hyperdriver_core::service::make_service_fn;
    use hyperdriver_core::stream::duplex;
    use tower::service_fn;
    ...
    fn compile() {
        let svc = make_service_fn(|_| {
            ready(Ok::<_, Infallible>(service_fn(|_: http::Request<Body>| {
                ready(Ok::<_, Infallible>(http::Response::new(
                    hyperdriver_body::Body::from("hello"),
                )))
            })))
        });
