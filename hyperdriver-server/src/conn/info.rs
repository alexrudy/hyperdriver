...
/// # use hyperdriver_core::info::ConnectionInfo;
/// # use hyperdriver_server::conn::MakeServiceConnectionInfoLayer;
/// # use tower::Layer;
/// use hyperdriver_core::service::{make_service_fn, service_fn};
...
mod tests {
    ...
    async fn connection_info_from_service() {
        let service = tower::service_fn(|req: http::Request<hyperdriver_body::Body>| {
            let info = req
                .extensions()
        ...
        let req = http::Request::new(hyperdriver_body::Body::empty());
