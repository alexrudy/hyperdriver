...
use hyperdriver_core::{service::ServiceRef, stream::tls::TlsHandshakeInfo};
...
mod future {
    ...
    use hyperdriver_core::info::tls::TlsConnectionInfoReciever;
    use hyperdriver_core::service::ServiceRef;
...
pub struct TlsConnection<S> {
    inner: S,
    rx: hyperdriver_core::info::tls::TlsConnectionInfoReciever,
}
...
mod tests {
    ...
    async fn tls_server_info() {
        ...
        let service = tower::service_fn(|req: http::Request<hyperdriver_body::Body>| async {
